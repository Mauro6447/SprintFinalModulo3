...
INSERT INTO productos VALUES (
     'NIKE-AIR-NE-38','16468799-6','Zapatillas de entrenamiento negras modelo Air Force de Nike de la talla 38','deportes',10,35000,'NegrO'),
	('CONV-02-38','16468799-6','Zapatillas Converse blancas talla 38','deportes',15,25000,'Blanco'),
	('673Z3LT#ABM','18232782-4','HP 240 G8 Ci5-1135G7 W11P 8G 256 SSD','computacion',4,750000,'Negro'),
	('9TG18','18232782-4','NBK Gamer 5520 I7-12700H 8GB 512GBSSD W11H RTX3050','computacion',4,1200000,'Carbon'),
	('849119001','26929717-4','Polerón Cuello Redondo Con Capucha Hombre The King''s Polo Club','ropa hombre',50,20000,'Azul'),
	('902960001','26929717-4','Chaqueta Denim Cuello Camisero Hombre Rolly Go','ropa hombre',20,35000,'Beigue'),
	('900575001','17997943-8','Parka Aplicación En Cierres Cuello Alto Capucha Con Sherpa Mujer Geeps','ropa mujer',15,44000,'Negro'),
	('896708001','17997943-8','Blusa Mujer Lesage','ropa mujer',60,10000,'Blanco'),
	('878205001','16468397-4','Refrigerador Side By Side Hisense RC-56WS / No Frost / 428 Litros / A+','linea blanca',15,550000,'Plata'),
	('6Q0N4LA#ABM','18232782-4','HP Zbook Power G9, Ci9-12900H,RTXA1000','computacion',25,20000,'Plata');
...
select nombre, stock, id_proveedor from productos
